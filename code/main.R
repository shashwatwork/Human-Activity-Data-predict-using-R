...
####  In RF We can only change ntree, mtry
...
any(is.na(train.2.rf))
print(train.2.rf)
importance(train.2.rf, type=2)
par(mfrow=c(1,1))
plot(train.2.rf)
...
any(is.na(train.3.rf))
print(train.3.rf)
importance(train.3.rf, type=2)
par(mfrow=c(1,1))
plot(train.3.rf)
